  ...
  try {
    ...
    if (amount == 0) {
      res.render("withdrawal", {
        error: "Please increase your amount!",
        color: "red",
      });
      return 0;
    }
    ...
    if (amount > req.session.user.amount) {
      res.render("withdrawal", {
        error: `You have Rs. ${req.session.user.amount} in your account!`,
        color: "red",
      });
      return 0;
    } else if (amount > atmAmount) {
      res.render("withdrawal", {
        error: "Please reduce your amount!",
        color: "red",
      });
      return 0;
    }
    ...
    if (!receipt & (flag == 0)) {
      ...
      req.session.save();
      res.render("withdrawal", {
        error: "Your transaction is successfull!",
        color: "green",
      });
      flag = 1;
      ...
      req.session.save();
      res.render("withdrawal", {
        error: "Your transaction is successfull,Please collect your receipt!",
        color: "green",
      });
      flag = 1;
    } else if (flag == 0) {
